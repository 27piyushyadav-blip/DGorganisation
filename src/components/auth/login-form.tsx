...
import { Loader2, Mail, Lock, ArrowRight, Building, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col items-center text-center space-y-2">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-zinc-900">Organization Portal</h1>
        <p className="text-sm text-zinc-500">Enter your credentials to access your organization account.</p>
      </div>
