...
// 1. Extract the verification logic into a sub-component
...
// 2. Main page component provides the layout and Suspense boundary
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-8 py-12 lg:p-16">
        <Suspense fallback={
          <div className="flex flex-col items-center">
            ...
            <p className="text-zinc-500">Initializing verification...</p>
          </div>
        }>
          <VerifyContent />
        </Suspense>
