...
export default function ExchangePage() {
  ...
  const handleConfirmExchange = () => {
    ...
    toast.success("Edit Service Successfull");
    router.push('/exchangeservice');
  };
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            {exchangeConfirmed ? (
              <div className="flex items-center gap-2 px-3 py-2 bg-green-50 rounded-xl border border-green-200">
                ...
                <span className="text-sm text-green-700">Edit Completed</span>
              </div>
            ) : (
              <div className="flex items-center gap-2 px-3 py-2 bg-blue-50 rounded-xl border border-blue-200">
                <Repeat className="w-4 h-4 text-blue-600" />
                <span className="text-sm text-blue-700">Edit in Progress</span>
              </div>
            )}
          </div>
        </div>
                  ...
                  <div className="mt-6">
                    ...
                    {selectedServices.length > 0 ? (
                      ...
                      <div className="text-center py-10 bg-slate-50 rounded-xl">
                        ...
                        <p className="text-slate-400">No services selected for edit</p>
                ...
                <div className="p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">All edit transactions are logged for transparency</p>
                    </div>
                  </div>
